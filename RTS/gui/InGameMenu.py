...
class InGameMenu(object):
    ...
    def _initBaseTexture(self):
        ...
        pygame.draw.rect(self.BaseSurface, self.screenManager.colors["Black"], self.Rect, 10)
    ...
    def _initButtons(self):
        ...
        self.BackToGameButton = Button(self.main, self.screenManager.display_surf, 
                                         self.screenManager.colors["Gray"], self.screenManager.colors["Blue"], self.screenManager.colors["Yellow"], self.screenManager.colors["White"],
                                         self.x+self.Rect.centerx-75, self.y+60, 150, 80,
                                         "Back to Game", 30, self.BackToGame)
        self.ButtonMainMenu = Button(self.main, self.screenManager.display_surf, 
                                         self.screenManager.colors["Gray"], self.screenManager.colors["Blue"], self.screenManager.colors["Yellow"], self.screenManager.colors["White"],
                                         self.x+self.Rect.centerx-75, self.y+150, 150, 80,
                                         "Main Menu", 30, self.MainMenu)
        self.ButtonOptions = Button(self.main, self.screenManager.display_surf, 
                                         self.screenManager.colors["Gray"], self.screenManager.colors["Blue"], self.screenManager.colors["Yellow"], self.screenManager.colors["White"],
                                         self.x+self.Rect.centerx-75, self.y+240, 150, 80,
                                         "Options", 30, self.Options)
        self.ButtonQuit = Button(self.main, self.screenManager.display_surf, 
                                         self.screenManager.colors["Gray"], self.screenManager.colors["Blue"], self.screenManager.colors["Yellow"], self.screenManager.colors["White"],
                                         self.x+self.Rect.centerx-75, self.y+330, 150, 80,
                                         "Quit", 30, self.Quit)
