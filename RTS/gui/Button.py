...
class Button(object):
    ...
    def __init__(self, main, surface, in_color, bord_color, hover_color, text_color, x, y, sizeX, sizeY, text, textSize, onClick, border=5):
        '''
        Constructor
        '''
        self.main = main
    ...
    def _initRect(self):
        ...
        self.InRect = pygame.Rect(self.border, self.border, self.sizeX-self.border*2, self.sizeY-self.border*2)
